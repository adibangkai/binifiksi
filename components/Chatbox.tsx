export default function Chatbox() {
  return (
    <div className="grid gap-3 overflow-auto max-h-[92vh] pt-4">
      ...
      <div className="justify-self-end mr-4">
        <div className="out w-fit max-w-lg text-justify bg-sky-900 text-white p-4 rounded-xl rounded-tr-none ">
          hello im bocchi ur fav , Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Numquam quos omnis, quam laboriosam tempora cumque
          repudiandae perspiciatis aut facilis ipsam aliquid amet obcaecati
          blanditiis? Ex, culpa delectus? Debitis, suscipit reiciendis? Lorem
          ipsum dolor sit amet consectetur adipisicing elit. Sequi vero iure
          beatae, dolores quo aliquid voluptates excepturi rem eaque qui fugiat
          accusantium placeat a dolorem, doloribus accusamus, facilis vitae
          earum.
        </div>
        <div className="time mr-2 text-slate-400 font-extralight text-sm text-right">
          4.21 AM
